...
// I was getting this error so I took out the default 3rd parameter 

// pc6.cpp: In function ‘std::string prepareForDisplay(int*, int, char)’:
// pc6.cpp:114: error: default argument given for parameter 3 of ‘std::string prepareForDisplay(int*, int, char)’
// pc6.cpp:22: error: after previous specification in ‘std::string prepareForDisplay(int*, int, char)’
